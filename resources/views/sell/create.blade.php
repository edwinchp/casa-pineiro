                                                    ...
                                                    <div class="p-2">
                                                        <div class="dropdown-inverse dropdown open show">
                                                            <button
                                                                ...
                                                                aria-haspopup="true"
                                                                aria-expanded="true">Opciones</button>
                                                            <div class="dropdown-menu" aria-labelledby="dropdown-7"
                                                                ...
                                                                <a class="dropdown-item waves-light waves-effect"
                                                                    ...
                                                                    data-target="#saveModal">Guardar para después</a>
                                                                <a class="dropdown-item waves-light waves-effect"
                                                                    href="#" data-toggle="modal"
                                                                    data-target="#createProductModal">Crear producto</a>
                                                                <a class="dropdown-item waves-light waves-effect"
                                                                    href="#" data-toggle="modal"
                                                                    data-target="#createClientModal">Crear cliente</a>
                                                                <a class="dropdown-item waves-light waves-effect"
                                                                    href="#" data-toggle="modal"
                                                                    data-target="#cleanCartModal">Quitar productos</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon input-icon"><i
                                                                                class="icofont icofont-bar-code"></i></span>
                                                                        <input type="text"
                                                                            class="form-control form-control-lg input-autofocus"
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        ...
                                                                        <ul class="nav nav-tabs md-tabs tabs-left b-none"
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link active"
                                                                                    data-toggle="tab" href="#home5"
                                                                                    role="tab"
                                                                                    aria-expanded="false">Efectivo</a>
                                                                                <div class="slide"></div>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-toggle="tab"
                                                                                    ...
                                                                                    aria-expanded="false">Transferir</a>
                                                                                <div class="slide"></div>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-toggle="tab"
                                                                                    href="#messages5" role="tab"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="tab-pane" id="transfer"
                                                                                role="tabpanel" aria-expanded="false">
                                                                                <p class="m-0">Estos productos serán transferidos</p>
                                                                            </div>
                                                                            <div class="tab-pane row" id="messages5"
                                                                                role="tabpanel">
                                                                                <!-- aria-expanded="true" -->
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-12">
                                                                                        ...
                                                                                        <h6>Emmanuel Fernandez Rodriguez
                                                                                            <span class="pl-2"><a
                                                                                                    data-toggle="modal"
                                                                                                    data-target="#deleteClient"
                                                                                                    class="label label-danger btn">X</a></span>
                                                                                        </h6>
                                                                                    </div>
                                                        ...
                                                        <div class="sell-summary">
                                                            ...
                                                            <div class="row">
                                                                <button class="btn btn-success" data-toggle="modal"
                                                                    data-target="#confirmSell">Pagar</button>
                                                            </div>
